...
function fixChangePlural(fn) {
  return function (str) {
    ...
    const index =
      typeof (matches === null || matches === void 0
        ? void 0
    ...
    const suffixIndex =
      suffixMatches === null || suffixMatches === void 0
        ? void 0
        : suffixMatches.index;
  ...
  builder.hook("inflection", (oldInflection) => {
    return Object.assign(
      Object.assign(
        Object.assign(
          Object.assign(
            Object.assign(Object.assign({}, oldInflection), {
              /*
              ...
              getBaseNameFromKeys(detailedKeys) {
                ...
                if (pgSimplifyMultikeyRelations) {
                  const columnNames = detailedKeys.map((key) =>
                    this._columnName(key)
                  );
        ...
        ),
        {
          ...
          singleRelationByKeysBackwards(
            ...
            const baseName = this.getBaseNameFromKeys(detailedKeys);
            const oppositeBaseName =
              baseName && this.getOppositeBaseName(baseName);
            if (oppositeBaseName) {
              return this.camelCase(
          ...
          manyRelationByKeys(detailedKeys, table, foreignTable, constraint) {
            if (constraint.tags.foreignFieldName) {
              if (constraint.tags.foreignSimpleFieldName) {
                ...
                return (
                  constraint.tags.foreignFieldName +
